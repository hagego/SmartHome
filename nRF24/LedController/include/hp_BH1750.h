...
class SoftWire; /**< Forward declaration of SoftWire class */
extern SoftWire Wire; /**< Forward declaration of Wire object */
...
public:
  ...
  bool begin(byte address, SoftWire *myWire = &Wire);
  bool reset();
  bool powerOn();
  bool powerOff();
